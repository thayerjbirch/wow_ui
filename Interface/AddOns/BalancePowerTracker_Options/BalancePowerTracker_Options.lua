...
--CHANGELOG
v2.0.1 Updated for BalancePowerTracker v2.0.1:
       Included Peak cooldown options.
v2.0.0 Overhaul for 6.00.00
--]]
		...
		args	= {
				...
				args ={
					...
					visibility ={
						...
						args	= {
							...
							hideInVehi	= CreateToogle(nil,'Hide in vehicle',nil,"eclipse_bar","hideInVehicle"),
							showCustomize	= {
								type	= 'multiselect',
					...
					barOptions ={
						...
						args	= {
							...
							barModeColorAll	= CreateToogle(nil,'Color all bar',"Color all bar with energy color.","eclipse_bar","barModeColorAll"),
							...
							barModeCastBar	= CreateToogle(nil,'Castbar mode: All Spells',"When casting a spell, the spark travels all the bar.","eclipse_bar","barModeCastBar"),
					...
					eclipse_icons = {
						...
						args ={
							...
							cooldown	= CreateToogle(nil,'Show duration as cooldown',nil,"eclipse_bar","showIconsCooldown"),
							text		= CreateToogle(nil,'Show duration as text',nil,"eclipse_bar","showIconsText"),
						},
					},
					color ={
						name	= "Color",
			...
			Warning = {
				...
				args ={
					...
					editFontP	= CreateToogle(nil,'Edit font path',nil,"warning_text","edit_font_path"),
					fontPath	= {
						type	= 'input',
						name	= 'Font path',
						hidden	= function () return not opt.warning_text.edit_font_path end,
						get		= function () return opt.warning_text.font end,
						set		= function (_,new) opt.warning_text.font = new end,
						order	= getOrder(),
					},
					header1 = CreateHeader(nil,""),	
				...
				args ={
					...
					visibility ={
						...
						args	= {
							...
							hideInVehi	= CreateToogle(nil,'Hide in vehicle',nil,"default_art","hideInVehicle"),
							showCustomize	= {
								type	= 'multiselect',
